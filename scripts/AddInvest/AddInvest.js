...
const Modal = {
  ...
  const Storage = {
    ...
    get() {
      return JSON.parse(localStorage.getItem("dev.financesss:investments")) || []; // Obtém as transações armazenadas no localStorage ou retorna um array vazio se não houver transações
    },
    set(transactions) {
      localStorage.setItem(
        "dev.financesss:investments",
